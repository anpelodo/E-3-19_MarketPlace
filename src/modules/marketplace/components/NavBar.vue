<template>
  <nav class="marketplace_nav">
    <div class="nav_left">
      <a class="bars pointer">
...
.marketplace_nav .nav_left i {
  margin-right: 1rem;
}

.marketplace_nav .nav_right i {
  margin-left: 1rem;
}
